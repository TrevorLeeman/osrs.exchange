...
const SearchIcon = ({ className }: SearchIconProps) => (
  <svg
    ...
    xmlSpace="preserve"
    className={twMerge(['h-4 w-4 fill-gray-800 dark:fill-gray-300', className])}
  >
    <g>
      <path
        d="M66.829,51.329L56.593,41.093c1.479-3.56,2.248-7.387,2.248-11.282c0-16.222-13.198-29.42-29.421-29.42
      ...
      />
      <path
        d="M29.42,13.061c-9.235,0-16.749,7.514-16.749,16.75s7.514,16.75,16.749,16.75c9.236,0,16.75-7.514,16.75-16.75
